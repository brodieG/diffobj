...
diffStr(a, b, extra=list(comp.str="^")) # "Specifying"
diffStr(a, b, extra=list(comp="^")) #  "Specifying")
diffStr(a, b, extra=list(indent.str="...")) #  "Specifying"
diffStr(a, b, extra=list(indent="...")) # "Specifying"
